<template>
  <main>
    <div
      class="bg-primary text-white flex min-h-screen flex-col items-center pt-16 sm:justify-center sm:pt-0"
    >
      <a href="#">
        <div
        ...
        >
          <div>
            <img src="../assets/logo-white.png" class="sm:h-10 h-8" alt />
          </div>
        </div>
      </a>
      <div class="relative mt-12 w-full max-w-lg sm:mt-10">
        ...
        >
          <div class="flex flex-col p-6">
            ...
            <p
              class="mt-1.5 text-sm font-medium text-white/50"
          ...
          <div class="p-6 pt-0">
            <form>
              ...
              <div class="mt-4 flex items-center justify-between">
                ...
                <a class="text-sm font-semibold text-foreground underline" href="/forgot-password">
                  Forgot
                  password?
                </a>
              </div>
              <div class="mt-4 flex items-center justify-end gap-x-2">
                <a
                  class="inline-flex items-center justify-center rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:border-white hover:border h-10 px-4 py-2 duration-200"
                  href="/register"
                >Register</a>
                <button
                  class="font-semibold hover:bg-[#20386D] hover:text-white hover:border-white hover:border transition duration-300 inline-flex items-center justify-center rounded-md text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-black h-10 px-4 py-2"
                  type="submit"
                >Log in</button>
              </div>
            </form>
